...
it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
  ...
  expect(
    getByText(appointment, "Confirm deletion?")
  ).toBeInTheDocument();
...
it("loads data, edits an interview and keeps the spots remaining for Monday by 1", async () => {
  ...
  await waitForElement(() => getByText(appointment, "Paris Lemay"));

  expect(getByText(container, "Sylvia Palmer")).toBeInTheDocument();

  expect(getByText(container, "Paris Lemay")).toBeInTheDocument();
